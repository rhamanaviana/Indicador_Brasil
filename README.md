...
Este projeto é o frontend de uma aplicação web que exibe os principais indicadores econômicos brasileiros, como Dólar (USD), Taxa Selic e IPCA.
O objetivo é oferecer uma visualização clara, interativa e atualizada desses indicadores, permitindo que o usuário acompanhe a evolução histórica e analise tendências econômicas.

# ✨ Sobre o Projeto

O site apresenta um design limpo e responsivo, com gráficos dinâmicos que mostram a evolução de cada indicador ao longo do tempo.
O usuário pode selecionar datas específicas para análise, visualizar gráficos históricos e converter valores de moedas em tempo real.
